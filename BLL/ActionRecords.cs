...
namespace TravelAgency.BLL
{
	...
	{
		private readonly TravelAgency.DAL.ActionRecords dal=new TravelAgency.DAL.ActionRecords();
		...
		/// 获得数据列表
		/// </summary>
		public List<TravelAgency.Model.ActionRecords> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<TravelAgency.Model.ActionRecords> DataTableToList(DataTable dt)
		{
			List<TravelAgency.Model.ActionRecords> modelList = new List<TravelAgency.Model.ActionRecords>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				TravelAgency.Model.ActionRecords model;
